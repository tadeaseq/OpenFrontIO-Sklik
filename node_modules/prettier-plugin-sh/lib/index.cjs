...
const dockerPrinter = {
  ...
  print(_0, _1) {
    return __async(this, arguments, function* (path, {
      ...
      useTabs,
      tabWidth,
      indent = useTabs ? 0 : tabWidth != null ? tabWidth : 2,
      binaryNextLine = true,
      ...
      try {
        return yield formatDockerfileContents(path.node, {
          indent,
          spaceRedirects: spaceRedirects != null ? spaceRedirects : false,
        ...
        return shSyntax.processor(path.node, {
          ...
          binaryNextLine,
          switchCaseIndent,
          spaceRedirects: spaceRedirects != null ? spaceRedirects : true,
          keepPadding,
          minify,
          singleLine,
          functionNextLine
